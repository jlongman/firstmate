...
| `fm-check-sandbox-policy.sh` | Own the claude crewmate srt confinement: preflight doctor, srt invocation, and the per-task `srt-settings.json` shape (docs/crewmate-sandbox.md) |
